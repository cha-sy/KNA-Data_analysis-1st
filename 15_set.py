...
# 실습 4 셋으로 중복 센서 제거하기
logs = ["WOR 01", "WOR 01", "WOR 01", "WOR 01", "WOR 06", "WOR 06", "WOR 03", "WOR 05"]
unique = set(logs)
print(sorted(unique))
...
# 집합 연산
hour_14 = {"WOR 01", "WOR 06", "WOR 07", "WOR 02"}
hour_15 = {"WOR 01", "WOR 07", "WOR 03", "WOR 09", "WOR 11"}

# 합집합
print(hour_14.union(hour_15))
print(hour_15.union(hour_14))  # 두 코드는 동일한 동작을 함
# {'WOR 06', 'WOR 09', 'WOR 07', 'WOR 11', 'WOR 01', 'WOR 02', 'WOR 03'}
print(hour_14)  # .union은 원본 셋에 변화 x
