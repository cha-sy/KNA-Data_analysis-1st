...
# input은 하나의 매개변수(아규먼츠, 인자)만 받을 수 있다고 에러발생
...
input("이름, 나이를 입력해주세요. (ex. 차승윤,29): ")

# ======================
# input으로 받은 값은 변수에 저장하지 않으면 휘발됨 (사라짐)
...
# 실습 2 - 숫자 입력받아 계산하기
birth = int(input("태어난 연도를 적어주세요"))
age = 2026 - birth + 1  # 우리나라 나이
print("나이:", age, "세")
...
print(float(12.3))  # float()에 실수를 입력해도 동작 됨
print(float("12.5"))
...
# 이럴 때 int를 str으로 변환해서 더하기 연산자 사용가능
