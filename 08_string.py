...
sen = "sensor_log.csv"
print(sen.startswith("sensor"))
print(sen.endswith(".csv"))
...
# 문자열의 가윤데 공백은 strip으로 지우지 못함
print("     정   상         ".strip())  # "정    상"
print(raw)  # "  정상          "
# strip은 재할당이나 새 변수에 할당되지 않는 이상 휘발
...
# 실습 5 리스트 합치기
day = ["2025", "01", "15"]
print("-".join(day))  # 2025-01-15 (사이에 - 넣어 합침)

# 실습 변수에 "python"이라는 문자열 할당, pyThon이라고 출력하기
# 방법1 슬라이싱 + T만 upper사용
kor = "python"

print(kor[:2] + kor[2].upper() + kor[3:])
...
# print("이런식으로 쓰죠?", "근데 안보이는 기본값이 있어요" sep="")
