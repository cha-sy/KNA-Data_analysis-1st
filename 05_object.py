...
# 이럴 경우 사용하지 않는 따옴표로 쌍을 맟춰 가장 바깥에 감싸줘야 함
illit = "It's me"
...
type(5)  # 터미넣에서 확인 불가 > print하지 않았기 때문
...
# 내가 터미널에서 출력된 결과 중에서
# type()을 사용해서 출력된 자료형을 쉽개 확인할 수 있는 방법
...
print(
    0.1 + 0.8
)  # 위 상황에서는 출력 되지만 가끔 컴퓨터 내부 연산 과정에서 아주 작은 오차가 발생하는 경우도 있음
